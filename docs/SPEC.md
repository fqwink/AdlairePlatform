...
> **ドキュメントバージョン**: Ver.0.3-12
> **ステータス**: 🔧 開発中（Ver.1.4-pre）
> **作成日**: 2026-03-06
> **最終更新**: 2026-03-10（Ver.1.4-pre 更新）
> **所有者**: Adlaire Group
...
> **注**: Ver.1.2系は Ver.1.2-26 をもって終了。Ver.1.3系（Ver.1.3-29）で 12 エンジンの実装を完了。Ver.1.4系で AppContext・Logger・MailerEngine を追加し 15 エンジン体制へ。
...
│   ├── AppContext.php            # アプリケーションコンテキスト管理
│   ├── Logger.php                # 構造化ログエンジン
│   ├── MailerEngine.php          # メール送信エンジン
│   └── JsEngine/
