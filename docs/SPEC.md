...
> **ドキュメントバージョン**: Ver.0.2-8
> **ステータス**: ✅ 確定（Ver.1.2系終了 / Ver.1.3系計画追記）
> **作成日**: 2026-03-06
> **最終更新**: 2026-03-08（Ver.1.3系ロードマップ追記）
> **所有者**: Adlaire Group
...
> **注**: Ver.1.2系は Ver.1.2-26 をもって終了。Ver.1.3系では StaticEngine・ApiEngine の実装に加え、管理ツールのダッシュボード化・エンジン駆動モデル化を実施予定。
