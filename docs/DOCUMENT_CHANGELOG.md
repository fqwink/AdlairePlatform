...
| バージョン | 更新日 | 変更内容 | 変更者 |
|-----------|--------|----------|--------|
| Ver.0.7-4 | 2026-03-15 | Ver.1.8 ドキュメント再整備: engines/ 参照を Framework/ に更新、重複セクション削除、不要項目整理 | Claude |
| Ver.0.6-3 | 2026-03-15 | Ver.1.8 移行: PHP 8.3+ 必須化、バージョン計画にVer.1.8追加、PHP対応仕様を8.3+に更新 | Claude |
...
| バージョン | 更新日 | 変更内容 | 変更者 |
|-----------|--------|----------|--------|
| Ver.1.6-3 | 2026-03-15 | Ver.1.8 ドキュメント再整備: engines/ 構成を Framework 統合構成に全面更新、重複セクション整理 | Claude |
| Ver.1.5-2 | 2026-03-15 | Ver.1.8 移行: ディレクトリ構成に Framework/AP/ 追加、controllers/ 廃止を反映 | Claude |
...
| バージョン | 更新日 | 変更内容 | 変更者 |
|-----------|--------|----------|--------|
| Ver.1.1-2 | 2026-03-15 | Ver.1.8 ドキュメント再整備: engines/ アクセス制限記述を Framework/ に更新 | Claude |
...
| バージョン | 更新日 | 変更内容 | 変更者 |
|-----------|--------|----------|--------|
| Ver.1.3-4 | 2026-03-15 | §4.1 ファイル構成原則を「3〜7ファイル集約化」に更新、§2.2 も同期更新 | Claude |
| Ver.1.2-3 | 2026-03-15 | AFE_IMPROVEMENT_ROADMAP_V2.md を統合: 改良ロードマップ（§13）を追加 | Claude |
| Ver.1.1-2 | 2026-03-15 | AFE_ENGINE_DRIVEN_MODEL.md を統合: エンジンライフサイクル（§5）、DI・イベント駆動規則（§6）を追加、セクション番号を再構成 | Claude |
...
| バージョン | 更新日 | 変更内容 | 変更者 |
|-----------|--------|----------|--------|
| Ver.1.3-4 | 2026-03-15 | Ver.1.8 ドキュメント再整備: 全ドキュメントの engines/ → Framework/ 更新の変更履歴を追加 | Claude |
| Ver.1.2-3 | 2026-03-15 | FRAMEWORK_RULEBOOK.md 新設に伴い管理対象追加、変更履歴セクション追加 | Claude |
| Ver.1.1-2 | 2026-03-15 | Ver.1.8 ドキュメント再整備の変更履歴を追加 | Claude |
